...
/*PROTECTED REGION ID(usingProyectoVikingsGenNHibernate.CEN.ProyectoVikings_Equipo_checkGrebas) ENABLED START*/
...
{
public bool CheckGrebas (int p_oid)
{
        /*PROTECTED REGION ID(ProyectoVikingsGenNHibernate.CEN.ProyectoVikings_Equipo_checkGrebas) ENABLED START*/
        ...
        if (equipo.GrebasEquipadas == true) {
                return true;
        }
        else
                return false;

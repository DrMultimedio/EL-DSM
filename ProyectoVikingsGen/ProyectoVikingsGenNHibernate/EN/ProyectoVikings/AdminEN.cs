...
{
        this.init (Id, admin.Nombre, admin.Email, admin.Cumple, admin.Genero, admin.Vidamax, admin.VidaAct, admin.Ataque, admin.Defensa, admin.Oro, admin.Inventario, admin.Batalla_PVE, admin.Batalla_PVP, admin.Batalla_PVP_0, admin.InventarioEquipado);
}
